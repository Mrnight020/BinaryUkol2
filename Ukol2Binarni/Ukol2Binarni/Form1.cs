...
namespace Ukol2Binarni
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                string celyradek = "" + ctibinary.ReadInt32() + ";" + ctibinary.ReadString() + ";" + ctibinary.ReadString() + ";" + ctibinary.ReadChar() + ";" + ctibinary.ReadInt32() + ";" + ctibinary.ReadInt32();

                textBox1.Text += celyradek;
                //listBox1.Items.Add(celyradek);
                /*listBox1.Items.Add(ctibinary.ReadInt32());
                listBox1.Items.Add(ctibinary.ReadString());
                listBox1.Items.Add(ctibinary.ReadString());
                listBox1.Items.Add(ctibinary.ReadChar());
                listBox1.Items.Add(ctibinary.ReadInt32());
                listBox1.Items.Add(ctibinary.ReadInt32());*/
            }
